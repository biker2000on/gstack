...
- **EXTERNAL-STATE** — Item names state in an external system: hosted database config, Cloudflare DNS, Vercel env vars, OAuth provider allowlists, third-party SaaS, DNS records. The current diff CANNOT prove this.
...
## Cross-Repo / External Items
  ...
  [UNVERIFIABLE] Hosted auth allowlist contains user email — external system, confirm in its dashboard
